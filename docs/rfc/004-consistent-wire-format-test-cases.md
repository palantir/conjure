...
The test-cases.json file is a well-structured file that will capture behaviour and edge cases from [wire_specification.md](../wire_specification.md), e.g.:
