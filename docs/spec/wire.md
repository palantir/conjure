...
## 3. Behaviour
### 3.1. Forward compatible clients
...
### 3.3. Servers reject unknown fields
...
### 3.4. Servers tolerate extra headers
...
### 4.6. Deserialization
#### 4.6.1. Coercing JSON `null` / absent to Conjure types
...
#### 4.6.2. Dedupe `set` / `map` keys using [Canonical JSON format][]
