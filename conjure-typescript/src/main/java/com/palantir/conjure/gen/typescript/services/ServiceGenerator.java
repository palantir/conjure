...
public interface ServiceGenerator {
     ...
     */
    Set<TypescriptFile> generate(ConjureDefinition conjureDefinition, ConjureImports conjureImports);
     ...
     */
    default void emit(ConjureDefinition conjureDefinition, ConjureImports conjureImports, File outputDir) {
        generate(conjureDefinition, conjureImports).forEach(f -> {
            try {
                f.writeTo(outputDir);
            } catch (IOException e) {
