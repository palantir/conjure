...
public interface ErrorGenerator {
    ...
    /**
     * Returns the set of Typescript files generated from the 'errors' definitions
     * in the given conjure specification.
     */
    Set<TypescriptFile> generate(
     ...
     */
    Map<ConjurePackage, Collection<ExportStatement>> generateExports(
            Map<TypeName, ErrorTypeDefinition> definitions, Optional<ConjurePackage> defaultPackage);
